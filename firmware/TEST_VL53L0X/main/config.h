...
#define PWM_RPWM_LEFT_IO                GPIO_NUM_9      // RPWM pin of the left motor
#define PWM_LPWM_LEFT_IO                GPIO_NUM_10     // LPWM pin of the left motor
#define PWM_RPWM_RIGHT_IO               GPIO_NUM_8      // RPWM pin of the right motor
#define PWM_LPWM_RIGHT_IO               GPIO_NUM_7      // LPWM pin of the right motor
