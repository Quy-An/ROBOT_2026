...
#define PWM_RPWM_LEFT_IO                GPIO_NUM_32      // RPWM pin of the left motor
#define PWM_RPWM_LEFT_CHANNEL           LEDC_CHANNEL_0   // LEDC channel for the RPWM pin of the left motor
#define PWM_LPWM_LEFT_IO                GPIO_NUM_33     // LPWM pin of the left motor
#define PWM_LPWM_LEFT_CHANNEL           LEDC_CHANNEL_1   // LEDC channel for the LPWM pin of the left motor
#define PWM_RPWM_RIGHT_IO               GPIO_NUM_22      // RPWM pin of the right motor
#define PWM_RPWM_RIGHT_CHANNEL          LEDC_CHANNEL_2   // LEDC channel for the RPWM pin of the right motor
#define PWM_LPWM_RIGHT_IO               GPIO_NUM_23      // LPWM pin of the right motor
#define PWM_LPWM_RIGHT_CHANNEL          LEDC_CHANNEL_3   // LEDC channel for the LPWM pin of the right motor
